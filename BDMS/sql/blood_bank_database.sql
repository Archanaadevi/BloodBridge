...
values("Aashin","apaashin","ap2101");
insert into admin_info(admin_name,admin_username,admin_password)
values("Deepika","deepikam","deepika123");
insert into admin_info(admin_name,admin_username,admin_password)
values("Sushmidha","sushmidhab","sushmidha123");
insert into admin_info(admin_name,admin_username,admin_password)
values("Archanaa","archanaam","archanaa123");
...
values("MIT Campus Anna University Blood Bank","bloodbank@gmail.com","7*********");
...
("Deepika","deepika@gmail.com","9*********","I need O+ Blood.");
